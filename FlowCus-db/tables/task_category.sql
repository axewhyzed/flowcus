...
-- task_category_name_key ON name (UNIQUE) - created by PRIMARY KEY constraint

-- Indexes for filtering active categories
-- Note: Partial unique index ensures unique names only among non-deleted categories
-- Deleted and active categories can share the same name without conflicts
